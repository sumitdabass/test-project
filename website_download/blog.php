...
$blogs = [
    ...
    ["category"=>"MBA","title"=>"IPU MCA Admission 2026: Programme Code 105, NIMCET, USICT Fee Rs.1.45L","url"=>"mca-admission-ipu.php","img"=>"assets/images/mca.jpg","alt"=>"IPU MCA Admission","excerpt"=>"2-year MCA via NIMCET → CET → CUET#. USICT USS tuition Rs.1,45,200/yr per PG Brochure Ch 14. 12+ affiliated colleges.","read_time"=>"6"],
];

$categories = ["All","B.Tech","MBA","Law","BBA","BJMC","CET","CUET","Economics","Colleges","Admissions"];
?>
<!DOCTYPE html>
<html lang="en">
<head>
