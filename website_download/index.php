...
<title>IPU Admission 2026 | IP University (GGSIPU) – Free Expert Guidance</title>
<meta name="description" content="IPU admission 2026 – B.Tech, MBA, Law, BBA, B.Com & more at IP University (GGSIPU). Free expert guidance for admission, counselling & management quota. Call 9899991342.">
...
<section id="ai-summary" itemscope itemtype="https://schema.org/EducationalOrganization" style="display:none">
  <p><span itemprop="name">IPU Admission Guide</span> (ipu.co.in) provides free expert guidance for <span itemprop="description">IP University (GGSIPU) admissions in 2026 including B.Tech, MBA, MCA, Law (BA LLB/BBA LLB), BBA, BCA, BJMC, B.Com, and BA Economics</span>. Covering 60+ affiliated colleges in Delhi. For admission guidance, contact <span itemprop="telephone">+91-9899991342</span> (Mon-Sat, 9 AM - 7 PM).</p>
</section>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-7 mb-4 mb-lg-0">
        ...
        <div style="background:rgba(245,158,11,.15);border-left:3px solid #f59e0b;padding:10px 14px;border-radius:6px;margin-bottom:20px;max-width:500px">
          <p style="color:#fff;font-size:14px;margin:0;font-weight:500">IPU Admission 2026 open — Limited seats, apply early!</p>
        </div>
      ...
      <div class="col-lg-5">
        <div style="background:#fff;border-radius:16px;padding:28px;box-shadow:0 20px 60px rgba(0,0,0,.2)">
          ...
          <p style="font-size:13px;color:#64748b;text-align:center;margin-bottom:16px">No charges. Our expert team will call you.</p>
...
<!-- ===== MID-PAGE CTA ===== -->
<?php
$cta_heading = "Need Expert Guidance for IPU Admission?";
$cta_subtext = "Get help with rank analysis, college shortlisting, management quota options and choice filling strategy";
...
<!-- ===== SECOND CTA ===== -->
<?php
$cta_heading = "Need Admission Help? Talk to Our Team";
$cta_subtext = "Call now for free, personalized help — we guide you from exam to seat allotment";
include_once("include/components/cta-strip.php");
?>
