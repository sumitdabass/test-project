...
<link rel="canonical" href="https://ipu.co.in/top-bca-colleges-ipu.php">
...
<meta property="og:url" content="https://ipu.co.in/top-bca-colleges-ipu.php">
...
<script type="application/ld+json">
{
  ...
  "mainEntityOfPage": {"@type": "WebPage", "@id": "https://ipu.co.in/top-bca-colleges-ipu.php"}
}
</script>
...
<script type="application/ld+json">
{
  ...
  "numberOfItems": 10,
  "itemListElement": [
    {"@type": "ListItem", "position": 1, "name": "VIPS Pitampura", "url": "https://ipu.co.in/top-bca-colleges-ipu.php#vips"},
...
<div class="col-lg-8">
  ...
  <p style="margin-top:14px"><strong>Honourable mentions for 2026-27:</strong> <a href="/dspsr-admission.php">DSPSR Rohini</a> (BCA 50 seats, focused single-shift cohort), <a href="/sgtbimit-admission.php">SGTBIMIT Model Town</a> (BCA 240), <a href="/echelon-admission.php">Echelon Faridabad</a> (BCA 120 + BCA Data Science 60), and <a href="/don-bosco-admission.php">Don Bosco Okhla</a> (BCA 120).</p>
...
$faqs = [
  ...
  ['question' => 'What is the eligibility for BCA in IPU?', 'answer' => 'Class 12 pass with at least 50% aggregate marks and English pass (45% for reserved categories). Mathematics OR Computer Science OR any subject related to Computer Science (e.g. Informatics Practices) is mandatory as one of the qualifying subjects (per UG Brochure 2026-27 Ch 2 p.35) — it is NOT optional. A valid GGSIPU CET (BCA) score (primary) or CUET (UG) score is required. Call 9899991342 to confirm eligibility.']
];
