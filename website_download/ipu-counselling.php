...
<meta name="twitter:title" content="IPU Counselling 2026 – Dates, Registration, Fees & Process">
<meta name="twitter:description" content="GGSIPU Counselling 2026 complete schedule – dates, registration, fee, choice filling, seat allotment for all courses. Call 9899991342.">
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "IPU Counselling 2026 – Dates, Registration, Fees, Process & Last Date",
  "description": "Complete guide to GGSIPU Counselling 2026 including registration dates, last date, counselling fees, choice filling and seat allotment for all courses.",
...
<!-- Hero -->
<?php
$hero_title = "IPU Counselling 2026 – Complete Schedule, Registration & Process";
$hero_subtitle = "Dates, last date, fees, choice filling & seat allotment for all GGSIPU courses";
$hero_breadcrumbs = [['Home', '/'], ['Admissions', '/ipu-admission-guide.php'], ['IPU Counselling 2026', '']];
$hero_compact = true;
...
<div class="col-lg-8">
  ...
  <h2>IPU Counselling 2026 Registration – Step-by-Step Process</h2>
  <p>Follow this 8-step process to register for GGSIPU counselling 2026 online. If you get stuck at any step, call <a href="tel:+919899991342">9899991342</a> for free assistance.</p>

  <ol>
    <li><strong>Visit the official portal:</strong> Go to <a href="https://ipu.ac.in" target="_blank" rel="noopener">ipu.ac.in</a> or <a href="https://ipu.admissions.nic.in" target="_blank" rel="noopener">ipu.admissions.nic.in</a> and click on the "Admissions 2026-27" link.</li>
    <li><strong>New Registration:</strong> Enter your name, mobile number, email ID, date of birth and create a strong password. Save your registration number safely.</li>
    <li><strong>Fill Personal & Academic Details:</strong> Enter your category (Gen/OBC/SC/ST/EWS), region (Delhi / Outside Delhi), parent details, 10th/12th marks, and entrance exam score (JEE Main / CUET / IPU CET / CLAT etc.).</li>
    <li><strong>Upload Documents:</strong> Photograph, signature, 10th/12th marksheets, category certificate, JEE/CUET scorecard, region certificate, Aadhaar card.</li>
    <li><strong>Pay Counselling Fee:</strong> Pay Rs. 1,500 (Gen/OBC) or Rs. 750 (SC/ST) online via UPI, debit/credit card or net banking. This fee is non-refundable but is adjusted against the first-year tuition fee on admission.</li>
    <li><strong>Choice Filling:</strong> Once choice filling opens, log in and fill your preferred colleges and branches in priority order. You can add unlimited choices — the more you add, the higher your chances.</li>
    <li><strong>Seat Allotment:</strong> Wait for the round-wise allotment result. If you get a seat, decide whether to "Freeze", "Float", or "Withdraw".</li>
    <li><strong>Reporting & Admission:</strong> Pay part-academic fee and report to the allotted college with original documents within the stipulated date.</li>
  </ol>

  <h2>IPU Counselling Fees 2026</h2>
  <p>The IPU counselling registration fee is one of the lowest among Indian state universities. The fee structure (tentative for 2026, based on 2025 rates) is:</p>
  <ul>
    <li><strong>General / OBC / EWS:</strong> Rs. 1,500</li>
    <li><strong>SC / ST / PwD:</strong> Rs. 750</li>
    <li><strong>NRI / Foreign Nationals:</strong> USD 50 (for international applicants)</li>
  </ul>
  <p>This counselling fee is a one-time payment and covers participation in all rounds (Round 1, 2, 3 and Spot). It is adjusted against the first-year tuition fee once you are admitted. For doubts on payment failures or refunds, call <a href="tel:+919899991342">9899991342</a>.</p>

  <h2>Required Documents for IPU Counselling 2026</h2>
  <p>Keep these 12 documents ready (in PDF/JPEG, max 200 KB each) before starting registration:</p>
  <ol>
    <li>Class 10 marksheet & passing certificate</li>
    <li>Class 12 marksheet & passing certificate</li>
    <li>Entrance exam scorecard (JEE Main / CUET / IPU CET / CLAT / NEET / MAT / GMAT)</li>
    <li>Recent passport-size colour photograph (with white background)</li>
    <li>Scanned signature</li>
    <li>Category certificate (SC/ST/OBC-NCL/EWS) — if applicable</li>
    <li>Region/Domicile certificate (for Delhi quota — Class 10 from Delhi school is accepted)</li>
    <li>Aadhaar card</li>
    <li>Date of birth proof</li>
    <li>Income certificate (for EWS / fee waiver)</li>
    <li>Defence / J&K migrant / Kashmiri Migrant certificate (if applicable)</li>
    <li>Disability certificate (for PwD candidates)</li>
  </ol>
  ...
  <ul>
    <li><strong>Round 1:</strong> First seat allotment based on choice filling. You can Freeze, Float, or Withdraw your seat.</li>
    <li><strong>Round 2:</strong> Vacant seats from Round 1 are re-allotted to candidates who chose "Float" or new candidates with lower ranks.</li>
    <li><strong>Round 3 / Sliding Round:</strong> Internal sliding to upgrade seats based on remaining vacancies. Existing students can get a better branch/college without losing their current seat.</li>
    <li><strong>Spot / Physical Round:</strong> The last chance for unfilled seats. Conducted offline at the campus. Open to candidates who registered earlier but didn't get a seat.</li>
  </ul>

  <h2>Important IPU Counselling 2026 Links</h2>
  <ul>
    <li>Official IPU website: <a href="https://ipu.ac.in" target="_blank" rel="noopener">ipu.ac.in</a></li>
    <li>IPU Admissions portal: <a href="https://ipu.admissions.nic.in" target="_blank" rel="noopener">ipu.admissions.nic.in</a></li>
    <li>GGSIPU Admission Brochure 2026-27 (PDF — released April 2026)</li>
    <li>IPU Result Portal: <a href="https://ipuresults.nic.in" target="_blank" rel="noopener">ipuresults.nic.in</a></li>
  </ul>

  <p>Confused about which college to choose, what your rank can get you, or how to do effective choice filling? Our IPU counselling experts have helped 5,000+ students secure their dream seat over the last 12 years. Call <a href="tel:+919899991342"><strong>9899991342</strong></a> today for a free 20-minute counselling call.</p>
...
<!-- CTA Strip -->
<?php $cta_heading = "Need Help with IPU Counselling 2026?"; $cta_subtext = "Talk to our admission expert for free choice filling strategy and seat predictions"; include 'include/components/cta-strip.php'; ?>
...
$faqs = [
  ...
  ['question' => 'What is the IPU counselling cutoff for B.Tech CSE?', 'answer' => 'For top colleges like USICT Dwarka, the JEE Main cutoff is around the 35,000 All India Rank for CSE in Round 1 (Delhi quota). MAIT and MSIT close around 85,000-90,000 for CSE. Cutoffs relax by 20-30% by Round 3. See our IPU B.Tech Cutoff Analysis for branch-wise data.'],
  ['question' => 'Can I get a refund of IPU counselling fee?', 'answer' => 'The Rs. 1,500 counselling registration fee is non-refundable. However, if you take admission, the amount is adjusted against your first-year tuition fee. The academic fee (paid after seat allotment) is refundable as per UGC slabs if you withdraw before classes start.'],
  ['question' => 'What is IPU sliding round and should I participate?', 'answer' => 'The sliding round (also called upward movement round) lets existing IPU students upgrade to a higher-preferred branch or college without losing their current seat. If you got a low-preference seat in Round 1 or 2, you should definitely participate in sliding to improve your branch.']
];
