...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "potentialAction": {
        "@type": "SearchAction",
        "target": {"@type": "EntryPoint", "urlTemplate": "https://ipu.co.in/blog.php?s={search_term_string}"},
...
<section id="ai-summary" itemscope itemtype="https://schema.org/EducationalOrganization" style="display:none">
  <p><span itemprop="name">IPU Admission Guide</span> (ipu.co.in) provides free expert counselling for <span itemprop="description">IP University (GGSIPU) admissions in 2026 including B.Tech, MBA, MCA, Law (BA LLB/BBA LLB), BBA, BCA, BJMC, B.Com, and BA Economics</span>. Covering 60+ affiliated colleges in Delhi. For admission guidance, contact <span itemprop="telephone">+91-9899991342</span> (Mon-Sat, 9 AM - 7 PM).</p>
</section>

<!-- ===== HERO SECTION ===== -->
<section class="hero-section" style="padding:60px 0 50px">
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-7 mb-4 mb-lg-0">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:8px;margin-bottom:20px">
          <span style="background:rgba(255,255,255,.1);padding:6px 14px;border-radius:20px;font-size:13px;color:rgba(255,255,255,.9)">NAAC A++ Accredited</span>
          <span style="background:rgba(255,255,255,.1);padding:6px 14px;border-radius:20px;font-size:13px;color:rgba(255,255,255,.9)">Government University</span>
          <span style="background:rgba(255,255,255,.1);padding:6px 14px;border-radius:20px;font-size:13px;color:rgba(255,255,255,.9)">60+ Colleges</span>
        </div>
        ...
        <div style="background:rgba(245,158,11,.15);border-left:3px solid #f59e0b;padding:10px 14px;border-radius:6px;margin-bottom:20px;max-width:500px">
          <p style="color:#fff;font-size:14px;margin:0;font-weight:500">IPU Counselling 2026 announced — Limited seats, apply early!</p>
        </div>
      ...
      <div class="col-lg-5">
        <div style="background:#fff;border-radius:16px;padding:28px;box-shadow:0 20px 60px rgba(0,0,0,.2)">
          <h3 style="font-size:1.15rem;color:#0d1b6e;margin-bottom:4px;text-align:center">Get Free Admission Guidance</h3>
          <p style="font-size:13px;color:#64748b;text-align:center;margin-bottom:16px">No charges. Expert counsellors will call you.</p>

          <?php if ($form_error): ?>
            <div style="background:#fef2f2;border:1px solid #fecaca;color:#dc2626;padding:8px 12px;border-radius:6px;font-size:13px;margin-bottom:12px"><?= $form_error ?></div>
          <?php endif; ?>
          ...
          <form method="POST" action="/sendemail.php" class="enquiry-form" novalidate>
            ...
            <div style="margin-bottom:10px">
              <input type="text" name="name" placeholder="Full Name" required autocomplete="name"
                     style="width:100%;padding:12px 16px;border:1px solid #e2e8f0;border-radius:8px;font-size:14px;transition:border-color .2s"
            ...
            <div style="margin-bottom:14px">
              <select name="course" required class="form-select"
                      style="width:100%;padding:12px 16px;border:1px solid #e2e8f0;border-radius:8px;font-size:14px;color:#64748b;background:#fff">
                ...
                <option value="Counselling">Counselling Help</option>
                <option value="Other">Other</option>
              </select>
            </div>
            <button type="submit"
                    style="width:100%;padding:14px;background:#e65c00;color:#fff;border:none;border-radius:8px;font-size:16px;font-weight:700;cursor:pointer;transition:background .2s;box-shadow:0 3px 12px rgba(230,92,0,.3)"
                    onmouseover="this.style.background='#cc5200'" onmouseout="this.style.background='#e65c00'">
              Request a Callback
            </button>
            <p style="font-size:11px;color:#94a3b8;text-align:center;margin:10px 0 0">100% Free. No spam, ever.</p>
          </form>
        </div>
      </div>
...
$courses = [
    ...
    ['name' => 'BCA', 'exam' => 'CUET / IPU CET', 'url' => '/ipu-admission-guide.php', 'icon' => 'code'],
    ['name' => 'BJMC', 'exam' => 'CUET / IPU CET', 'url' => '/guide-to-bjmc-colleges-under-ip-university.php', 'icon' => 'pen'],
];
include_once("include/components/course-card.php");
?>

<!-- ===== MID-PAGE CTA ===== -->
<?php
$cta_heading = "Talk to Our Experts — Free Guidance for Your Course";
$cta_subtext = "Get personalized admission counselling for B.Tech, MBA, BBA, Law, and all IPU programs";
include_once("include/components/cta-strip.php");
?>

<!-- ===== TOP COLLEGES ===== -->
<?php
$colleges = [
    ['name' => 'MAIT', 'full_name' => 'Maharaja Agrasen Institute of Technology', 'location' => 'Rohini, Delhi', 'url' => '/exploring-MAIT-and-MAIMS.php', 'img' => 'assets/images/exploring-MAIT-and-MAIMS.jpg'],
...
<section style="padding:50px 0">
  <div class="container">
    <h2 style="text-align:center;margin-bottom:12px">Latest Admission Guides & Updates</h2>
    <p style="text-align:center;color:#4a5568;margin-bottom:36px">Expert resources to help you navigate IPU admissions 2026</p>

    <div class="row g-4">
      <?php
      $blog_highlights = [
          ['title' => 'IP University Admission Guide 2026 – Complete Master Guide', 'url' => '/ipu-admission-guide.php', 'img' => 'assets/images/blog1.jpg', 'desc' => 'Complete step-by-step guide covering all IPU courses, eligibility, entrance exams, counselling process & management quota.'],
          ['title' => 'IPU B.Tech Admission 2026 — JEE Main, Colleges & Counselling', 'url' => '/IPU-B-Tech-admission-2026.php', 'img' => 'assets/images/IP-University-b-tech-admission.jpg', 'desc' => 'JEE Main cutoffs, top colleges like MAIT, MSIT, BPIT — everything for B.Tech 2026.'],
          ['title' => 'GGSIPU Counselling Process — Step-by-Step Guide', 'url' => '/GGSIPU-counselling-for-B-Tech-admission.php', 'img' => 'assets/images/ggsipu-counselling.jpg', 'desc' => 'How to register, fill choices, lock seat & complete document verification.'],
      ];
      foreach ($blog_highlights as $post): ?>
      <div class="col-lg-4 col-md-6">
        <a href="<?= $post['url'] ?>" style="display:block;background:#fff;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;text-decoration:none;transition:all .2s;height:100%"
           onmouseover="this.style.boxShadow='0 8px 30px rgba(0,0,0,.08)';this.style.transform='translateY(-3px)'"
           onmouseout="this.style.boxShadow='none';this.style.transform='none'">
          <div style="height:200px;overflow:hidden;background:#f0f4ff">
            <?php include_once("include/image-helper.php"); webp_img($post['img'], $post['title'], 'img-fluid', true); ?>
          </div>
          <div style="padding:20px">
            <h3 style="font-size:16px;color:#0d1b6e;margin-bottom:8px;line-height:1.4"><?= $post['title'] ?></h3>
            <p style="font-size:13px;color:#4a5568;margin:0;line-height:1.6"><?= $post['desc'] ?></p>
            <span style="display:inline-block;margin-top:12px;color:#1a3a9c;font-size:14px;font-weight:600">Read Guide →</span>
          </div>
        </a>
      </div>
      <?php endforeach; ?>
    ...
    <div style="text-align:center;margin-top:32px">
      <a href="/blog.php" style="display:inline-flex;align-items:center;gap:6px;background:#f0f4ff;color:#1a3a9c;padding:12px 28px;border-radius:8px;font-weight:600;text-decoration:none;transition:all .2s;border:1px solid #d0d9f0"
         onmouseover="this.style.background='#1a3a9c';this.style.color='#fff'" onmouseout="this.style.background='#f0f4ff';this.style.color='#1a3a9c'">
        View All Guides
...
<?php
$faqs = [
    ['question' => 'How to get admission in IP University for B.Tech 2026?', 'answer' => 'B.Tech admission at IP University is based on JEE Main rank. Students must participate in GGSIPU centralized counselling. Top colleges include MAIT Rohini, MSIT Janakpuri, BPIT Rohini, BVP and VIPS Pitampura. Call <a href="tel:+919899991342">9899991342</a> for free step-by-step guidance.'],
...
<!-- ===== SECOND CTA ===== -->
<?php
$cta_heading = "Ready to Start Your IPU Admission Journey?";
$cta_subtext = "Call now for free, personalized counselling — we guide you from exam to seat allotment";
include_once("include/components/cta-strip.php");
?>
