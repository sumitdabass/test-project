...
<title>IPU Law Admission 2026 | BA LLB, BBA LLB, LLM Fees, CLAT Cutoff Guide</title>

<meta name="description" content="IP University Law Admission 2026 – BA LLB (5 Yr) / BBA LLB / LLM via CLAT. 14 colleges, fees Rs.1.4-2.1L/yr, cutoff, VIPS/USLLS/MAIMS guide. Call 9899991342.">
...
<img fetchpriority="high" decoding="async" width="1000" height="600" src="assets/images/IPU-Law-Admission-2025.jpg" class="main-img" alt="IPU Law Admission Guide">
...
<p>
Guru Gobind Singh Indraprastha University (GGSIPU) offers integrated law programmes like BA LL.B and BBA LL.B through affiliated institutes and university schools. Admission is primarily based on CLAT scores followed by centralized counselling.
</p>
...
<h2>Eligibility Criteria for IPU Law Admission</h2>

<ul>
<li>Passed Class 12 from a recognised board</li>
<li>Minimum 50% aggregate marks (subject to official notification)</li>
<li>Valid CLAT UG score</li>
<li>Students appearing in Class 12 can also apply</li>
</ul>
...
<h2>Detailed Eligibility (Programme Code 121 &mdash; 5-yr Integrated BA-LLB / BBA-LLB)</h2>

<ul>
<li>Class 12 pass (or appearing) with minimum <strong>50% aggregate</strong> (45% for SC/ST)</li>
<li><strong>Maximum age:</strong> 22 years for General; 24 years for SC/ST/OBC (as on 1st October of the admission year)</li>
<li><strong>For LLM (1 year &mdash; Programme Code 112):</strong> LL.B. degree with 50% aggregate (45% for SC/ST)</li>
<li><strong>For LLB 3-Year (Programme Code 238):</strong> Bachelor's degree in any discipline with minimum 50% aggregate</li>
</ul>
...
<th style="padding:10px 14px;text-align:left">Primary Entrance</th>
<th style="padding:10px 14px;text-align:left">Alternate</th>
</tr>
</thead>
<tbody>
<tr style="border-bottom:1px solid #e2e8f0"><td style="padding:10px 14px">BA-LLB / BBA-LLB</td><td style="padding:10px 14px"><strong>CLAT UG 2026</strong></td><td style="padding:10px 14px">CUET (UG)</td></tr>
<tr style="border-bottom:1px solid #e2e8f0;background:#f8faff"><td style="padding:10px 14px">LLM (1 year)</td><td style="padding:10px 14px"><strong>CLAT PG 2026</strong></td><td style="padding:10px 14px">CUET PG</td></tr>
<tr style="border-bottom:1px solid #e2e8f0"><td style="padding:10px 14px">LLB (3-Year)</td><td style="padding:10px 14px"><strong>IPU CET</strong></td><td style="padding:10px 14px">&mdash;</td></tr>
</tbody>
</table>
</div>
...
<h2>Fee Structure 2026-27 (USLLS &mdash; University School of Law &amp; Legal Studies)</h2>

<p><strong>BA LLB / BBA LLB Tuition Fee per year:</strong></p>
...
<tbody>
<tr style="border-bottom:1px solid #e2e8f0"><td style="padding:10px 14px">Year 1</td><td style="padding:10px 14px">1,45,200</td></tr>
<tr style="border-bottom:1px solid #e2e8f0;background:#f8faff"><td style="padding:10px 14px">Year 2</td><td style="padding:10px 14px">1,59,720</td></tr>
<tr style="border-bottom:1px solid #e2e8f0"><td style="padding:10px 14px">Year 3</td><td style="padding:10px 14px">1,75,692</td></tr>
<tr style="border-bottom:1px solid #e2e8f0;background:#f8faff"><td style="padding:10px 14px">Year 4</td><td style="padding:10px 14px">1,93,261</td></tr>
<tr style="border-bottom:1px solid #e2e8f0"><td style="padding:10px 14px">Year 5</td><td style="padding:10px 14px">2,12,587</td></tr>
</tbody>
</table>
</div>
...
<h2>Affiliated Law Colleges (14)</h2>

<p>
The following 14 colleges are affiliated to GGSIPU for law programmes:
</p>
...
<li>MSI &mdash; Maharaja Surajmal Institute</li>
<li>TIPS Dwarka</li>
...
<ul>
<li><strong>CLAT UG / PG 2026:</strong> December 2025</li>
<li><strong>IPU Counselling:</strong> May&ndash;July 2026</li>
...
<h2>Top Law Colleges under IP University</h2>
...
<h2>Delhi vs Outside Delhi Category</h2>

<p>
IP University follows separate seat allocation for Delhi region and Outside Delhi candidates.
</p>

<ul>
<li>Delhi Category: Class 12 passed from Delhi school</li>
<li>Outside Delhi Category: Other state candidates</li>
<li>Seats are allocated separately during counselling</li>
</ul>

<hr>

<h2>Quota Categories in IP University Law Admission</h2>

<ul>
<li>General Merit Seats (via CLAT + Counselling)</li>
<li>Management Quota (Self-financing colleges)</li>
<li>Single Girl Child Quota</li>
<li>Sports Quota</li>
</ul>

👉 Management quota guide:
<a href="IP-University-management-quota-admission-eligibility-criteria.php">
IPU Management Quota Admission
</a>

<hr>

<h2>IPU Law Admission Process (Step-by-Step)</h2>

<ol>
<li>Register on official IPU admission portal</li>
<li>Pay counselling registration fee</li>
<li>Participate in counselling rounds</li>
<li>Fill college preferences based on CLAT rank</li>
<li>Seat allotment & document verification</li>
<li>Report to allotted college</li>
</ol>

👉 Counselling process explained:
<a href="GGSIPU-counselling-for-B-Tech-admission.php">
IPU Counselling Guide
</a>

<hr>

<h2>Final Advice for Law Aspirants</h2>

<p>
With a good CLAT score and proper counselling strategy,
students can secure admission into top IP University law colleges.
Understanding category-wise cutoffs and college priorities
plays a major role during seat allotment.
</p>
