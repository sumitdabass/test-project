...
$college_data = [
    ...
    'fees' => [],
    'faqs' => [
        ['question' => 'How to take admission in DIST under IPU 2026?', 'answer' => 'Admission is via the GGSIPU centralised counselling on JEE Main rank. Register on the IPU admission portal, fill DIST as a preference during choice filling, and report to the college upon allotment. Call 9899991342 for step-by-step guidance.'],
        ['question' => 'What B.Tech branches does DIST offer?', 'answer' => 'DIST offers Computer Science & Engineering under IPU. Seat intake varies per branch — call 9899991342 for the latest seat matrix.'],
        ['question' => 'What was the DIST B.Tech cutoff for 2025?', 'answer' => 'The 2025 round-wise JEE Main rank cutoffs (Delhi & Outside Delhi) for DIST are tabulated below. Use them as guidance for the 2026 cycle. For personalised choice-filling help, call 9899991342.'],
        ['question' => 'How can I get the latest fee and placement info for DIST?', 'answer' => 'Fee structure follows the GGSIPU Delhi Gazette SFRC notification. For verified current fees, placements and cut-off support, call 9899991342 (Mon–Sat, 9 AM – 7 PM).']
    ],
    'related_pages' => [
